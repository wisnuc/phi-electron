...
const { initMainWindow, getMainWindow, openAboutWindow } = require('./window')
...
const updateTray = () => {
  tray = null // required for ubuntu tray
  tray = new Tray(path.join(global.rootPath, 'public/assets/images/icon.png'))
