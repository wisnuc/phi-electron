...
const initMainWindow = () => {
  ...
  _mainWindow = new BrowserWindow({
    height: 700,
    width: process.env.NODE_ENV === 'production' ? 1100 : 1500,
    minHeight: 700,
    minWidth: process.env.NODE_ENV === 'production' ? 1100 : 1500,
    show: false,
    frame: false,
    transparent: false,
    resizable: true,
  ...
  if (process.env.NODE_ENV !== 'production') _mainWindow.webContents.openDevTools()
...
const openTrayWindow = () => {
  ...
  win.once('ready-to-show', () => {
    win.webContents.send('DATA', 'something')
    win.show()
  })
  return win
}
...
module.exports = { initMainWindow, getMainWindow, openAboutWindow, openTrayWindow, openBootWindow }
